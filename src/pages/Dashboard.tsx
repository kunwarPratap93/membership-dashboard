...
import type { MembershipType, SortOptions } from '../types/member';
...
export const Dashboard: React.FC = () => {
  ...
  const handleAddMember = async (data: { name: string; email: string; membershipType: MembershipType }) => {
    try {
  ...
  const handleUpdateType = (id: string, type: MembershipType) => {
    const member = members.find((m) => m.id === id);
  ...
  const handleHeaderSort = (field: SortOptions['field']) => {
    setSort((prev: SortOptions) => {
